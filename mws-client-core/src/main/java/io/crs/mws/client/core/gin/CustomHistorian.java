...
// allows the use of ValueChangeEvent.fire()
	...
	/**
	 * This method is responsible for extracting the path to use as history from the
	 * url.
	 */
	...
	/**
	 * This method is responsible for reading the browser url and converting it into
	 * a token that GWT Places can use.
	 * 
